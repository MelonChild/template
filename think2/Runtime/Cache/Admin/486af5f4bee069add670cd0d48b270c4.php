                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select data-placeholder="菜单icon" class="form-control setIcon"  name="icon">
                                            <?php if(is_array($menuClasses)): foreach($menuClasses as $key=>$menuClass): ?><option value="<?php echo ($menuClass["color"]); ?>"><?php echo ($menuClass["color"]); ?></option><?php endforeach; endif; ?>
                                        </select>
