                        ...
                        <form name="listForm">
                            <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
                                ...
                                <?php if(!empty($contents)): if(is_array($contents)): foreach($contents as $key=>$content): ?><tr>
                                            <td><label class="checkbox "><input type="checkbox" class='ids' value="<?php echo ($content[id]); ?>"></label></td>
                                            <td><a href="<?php echo U('',array('pid'=>$content[id]));?>"><?php echo ($content['name']); ?></a></td>
                                            <td><?php echo ($content['url']); ?></td>
                                            <td><p class="<?php echo ($content['class']); ?>"><?php echo ($content['class']); ?></p></td>
                                            <td><?php echo ($content['sort']); ?></td>
                                            <td><?php if($content[hide] == 1): ?>隐藏<?php else: ?>显示<?php endif; ?></td>
                                        <td class="ms">
                                            <div class="btn-group"> 
                                                <a class="btn btn-small" rel="tooltip" data-placement="left" data-original-title=" 编辑 " href="<?php echo U('edit',array('id'=>$content['id']));?>"><i class="gicon-edit"></i></a> 
                                                <a class="btn  btn-small" rel="tooltip" data-placement="bottom" data-original-title="删除" href="<?php echo U('delete',array('id'=>$content['id']));?>"><i class="gicon-remove "></i></a> 
                                            </div>
                                        </td>
                        ...
                        <div class="row-fluid  control-group mt15">
                            ...
                            <div class="pull-left span6 visible-desktop" action="#">
                                <div class="row-fluid fluid ">
                                    <button type="button" class="btn btn-inverse inline delete-all" url="<?php echo U('delete');?>">删除</button>
                                </div>
                            </div>
                            <div class="span6">
