...
<div class="wrap-fluid">
            ...
            <div class="col-sm-7">
                ...
                <div class="tittle-middle-header">
                    ...
                    <div class="alert">
                        ...
                        欢迎回来,&nbsp;
                        <strong><?php echo ($adminusers["name"]); ?>!</strong>&nbsp;&nbsp;上次登录时间：<?php echo ($lasttime); ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    <ul id="breadcrumb">
        ...
        <li><a href="<?php echo U('Admin/Index/index');?>" title="Sample page 1"><?php echo ($title); ?></a>
        </li>
        <li class="pull-right">
                    ...
                    <div class="body-nest" id="Footable">
                        <table class="table-striped footable-res footable metro-blue" data-page-size="6">
                            ...
                            <?php if(is_array($users)): foreach($users as $key=>$user): ?><tr>
                                    ...
                                    <td data-value="1">
                                <?php if($user[is_active] == 1): ?><span class="status-metro status-active" title="正常">正常</span>
                                    <?php else: ?>
                                    <span class="status-metro status-disabled" title="限制">限制</span><?php endif; ?>
