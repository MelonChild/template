...
<div class="wrap-fluid">
    ...
    <ul id="breadcrumb">
        ...
        <li><a title="Sample page 1"><?php echo ($title); ?></a>
        </li>
    </ul>
            ...
            <div class="col-sm-12">
                <div class="nest" id="FootableClose">
                    ...
                    <div class="body-nest" id="">
                        <p class="lead well"><input type="checkbox" class="check-all"> 全选 <button type="button" class="btn btn-inverse delete-all" url="<?php echo U('delete');?>">删除</button>
                            <a class='btn btn-default' href="<?php echo U('add');?>">新增</a>
                        </p>
                        <table class="table-striped footable-res footable metro-blue" data-page-size="6">
                            ...
                            <tbody>
                                <!--list contents start-->
                            <?php if(!empty($contents)): if(is_array($contents)): foreach($contents as $key=>$content): ?><tr>
                                        <td><input type="checkbox" class='ids' value="<?php echo ($content[id]); ?>"><?php echo ($content['id']); ?></td>
                                        <td><a href="<?php echo U('',array('pid'=>$content[id]));?>"><?php echo ($content['name']); ?></a></td>
                                        <td><?php echo ($content['url']); ?></td>
                                        <td><?php echo ($content['sort']); ?></td>
                                        <td><?php if($content[hide] == 1): ?>隐藏<?php else: ?>显示<?php endif; ?></td>
                                    <td class="ms">
                                        <div class="btn-group"> 
                                            <a class="btn btn-small" rel="tooltip" data-placement="left" data-original-title=" 编辑 " href="<?php echo U('edit',array('id'=>$content['id']));?>">编辑</a> 
                                            <a class="btn  btn-small" rel="tooltip" data-placement="bottom" data-original-title="删除" href="<?php echo U('delete',array('id'=>$content['id']));?>">删除</a> 
                                        </div>
                                    </td>
