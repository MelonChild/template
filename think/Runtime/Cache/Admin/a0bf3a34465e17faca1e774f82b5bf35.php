                    ...
                    <fieldset>
                        <div class="form-row control-group row-fluid">
                            ...
                            <div class="controls span9">
                                <input id="name" name="name"  value="<?php echo ($node["name"]); ?>" type="text" required class="span12"/>
                            </div>
                        </div>
                        <div class="control-group row-fluid">
                            <label class="control-label span2"><?php echo ($type); ?>描述</label>
                            <div class="controls span9">
                                <input type="text" name="title"  value="<?php echo ($node["title"]); ?>" placeholder="" class="row-fluid">
                            </div>
                        </div>
                        <div class="control-group row-fluid">
                            <label class="control-label span2"><?php echo ($type); ?>备注</label>
                            <div class="controls span9">
                                <input type="text" name="remark"  value="<?php echo ($node["remark"]); ?>" placeholder="" class="row-fluid">
                            </div>
                        </div>
                        <div class="control-group row-fluid">
                        ...
                        <div class="control-group row-fluid">
                            ...
                            <div class="controls span9">
                                <label class="inline radio">
                                    <input type="radio" name="status" value="1" <?php if($node['status'] == 1): ?>checked=""<?php endif; ?>>
                                    开启 </label>
                                <label class="inline radio">
                                    <input type="radio" name="status" value="0" <?php if($node['status'] == 0): ?>checked=""<?php endif; ?>>
                                    关闭 </label>
                            </div>
                        </div>
                        <div class="control-group row-fluid">
