                        ...
                        <form class="form-horizontal cmxform" id="validateForm" method="post" action="" autocomplete="off">
                            <div class="form-row control-group row-fluid">
                                ...
                                <div class="controls span9">
                                    <input id="name" name="name" type="text" required class="span12"/>
                                </div>
                            </div>
                            <div class="form-row control-group row-fluid">
                                <label class="control-label span2" for="hint-field">链接路径 <span class="help-block"></span> </label>
                                <div class="controls span9">
                                    <input id="url" name="url" type="text" required class="row-fluid"/>
                                </div>
                            </div>
                            <div class="form-row control-group row-fluid">
                                ...
                                <div class="controls span9">
                                    <select data-placeholder="顶级菜单" class="row-fluid" name="pid">
                                        ...
                                        <?php if(is_array($allMenus)): foreach($allMenus as $key=>$allMenu): ?><option value="<?php echo ($allMenu["id"]); ?>"><?php echo ($allMenu["name"]); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-row control-group row-fluid">
                                ...
                                <div class="controls span9">
                                    <input name="sort" type="text" required value="0" class="row-fluid"/>
                                </div>
                            </div>
                            <div class="form-row control-group row-fluid">
                                ...
                                <div class="controls span9">
                                    <select data-placeholder="菜单样式" class="row-fluid" name="class">
                                        <?php if(is_array($menuClasses)): foreach($menuClasses as $key=>$menuClass): if($menuClass[type] == 1): ?><option value="<?php echo ($menuClass["color"]); ?>" class="<?php echo ($menuClass["color"]); ?>"><?php echo ($menuClass["color"]); ?>颜色</option><?php endif; endforeach; endif; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-row control-group row-fluid">
                                ...
                                <div class="controls span9">
                                    <select data-placeholder="菜单icon"  name="icon" onchange=change(this)>
                                        <?php if(is_array($menuClasses)): foreach($menuClasses as $key=>$menuClass): if($menuClass[type] == 2): ?><option value="<?php echo ($menuClass["color"]); ?>" style="background-image: '/Public/Admin/img/menu_icons/<?php echo ($menuClass[color]); ?>'"><?php echo ($menuClass["color"]); ?></option><?php endif; endforeach; endif; ?>
                                    </select>
                            ...
                            <div class="form-row control-group row-fluid">
                                ...
                                <div class="controls span9">
                                    <fieldset>
                                        <label class="radio "><input type="radio" name="hide" value="0" checked/>显示</label>
                                        <label class="radio "><input type="radio" name="hide" value="1"/>隐藏</label>
