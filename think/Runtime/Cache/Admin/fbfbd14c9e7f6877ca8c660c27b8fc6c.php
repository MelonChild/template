                ...
                <form class="form-horizontal" id="validateForm" action='' method="POST">
                    <fieldset>
                        <div class="form-row control-group row-fluid">
                            <label class="control-label span2">角色名称 <span class="help-block"></span> </label>
                        ...
                        <div class="control-group row-fluid">
                            <!-- Email -->
                            <label class="control-label span2"  for="Email">角色描述</label>
                            <div class="controls span9">
                                <input type="text" name="remark"  value="<?php echo ($role["remark"]); ?>" required placeholder="" class="row-fluid">
                                <p class="help-block">用于后台用户所属角色</p>
                            </div>
                        </div>
                        <div class="control-group row-fluid">
                            <!-- Password -->
                            ...
                            <div class="controls span9">
                                <label class="inline radio">
                                    <input type="radio" name="status" id="toggle1-on" value="1" <?php if($role['status'] == 1): ?>checked=""<?php endif; ?>>
                                    开启 </label>
                                <label class="inline radio">
                                    <input type="radio" name="status" id="toggle1-off" value="0" <?php if($role['status'] == 0): ?>checked=""<?php endif; ?>>
                                    关闭 </label>
                            </div>
                        </div>
                        <div class="control-group row-fluid">
